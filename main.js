...
function wordLengths(str) {
  ...
  var newArray = [];
  each(newStr,function (word,i) {
    newArray[i] = word.length;
  })
  return newArray;
}
...
function wordsLongerThanThree(str) {
  ...
  return filter(newArray, function (word, i) {
...
var circle1 = Circle(30);
var circle2 = Circle(15);
...
/* It evaluates to (Numbers, Strings, Booleans), if its operand is a (Number, String, or Boolean) value and returns true or false based on the evaluation/*

//Q3 :How do we add a property to an object?

/* We must specify the object name followed by: a dot, the name of the new property, an equals sign (=), and the value for the new property. /*